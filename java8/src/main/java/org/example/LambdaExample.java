...
public class LambdaExample {
    ...
    public static void main(final String[] args) {
        ...
        Predicate<User> activeUserPredicate1 =new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.age >5;
            }
        ...
        repository.select(activeUserPredicate1, userComparator);
        ...
        Predicate<User> userPredicate2 =new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.active;
            }
        ...
        repository.select(userPredicate2, userComparator2);
        ...
        // TODO With functional interfaces declared
        Predicate <User> userPredicate3 =new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.active && user.age > 8;
            }
        };
        Comparator <User> userComparator3 = new Comparator<User>() {
            @Override
            public int compare(User o1, User o2) {
                return o1.name.compareTo(o2.name);
            }
        };
        repository.select(userPredicate3, userComparator3);
